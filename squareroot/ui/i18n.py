...
TRANSLATIONS = {
    "ru": {
        ...
        "menu.help.check_updates": "Проверить обновления…",
        "result.exact": "точно: {value}",
        "dialog.update.title": "Обновления",
        "dialog.update.available": "Доступна новая версия {latest} (у вас {current}).\nОткрыть страницу загрузки? Скачайте новый файл и удалите старый.",
        "dialog.update.latest": "У вас последняя версия ({current}).",
        "dialog.update.error": "Не удалось проверить обновления: нет соединения с GitHub или ответ некорректен.",
    },
    "en": {
        "menu.file": "File",
        "menu.file.quit": "Quit",
        ...
        "dialog.update.available": "A new version {latest} is available (you have {current}).\nOpen the download page? Download the new file and delete the old one.",
        "dialog.update.latest": "You have the latest version ({current}).",
        "dialog.update.error": "Could not check for updates: GitHub is unreachable or returned an invalid response.",
    },
    "es": {
        "menu.file": "Archivo",
        ...
        "result.exact": "exacto: {value}",
        "dialog.update.title": "Actualizaciones",
        "dialog.update.available": "Hay una nueva versión {latest} (usted tiene {current}).\n¿Abrir la página de descarga? Descargue el archivo nuevo y elimine el anterior.",
        "dialog.update.latest": "Tiene la última versión ({current}).",
        "dialog.update.error": "No se pudo buscar actualizaciones: GitHub no responde o la respuesta no es válida.",
    },
    "zh": {
        "menu.file": "文件",
        "menu.file.quit": "退出",
        ...
        "result.exact": "精确值：{value}",
        "dialog.update.title": "更新",
        "dialog.update.available": "有新版本 {latest}（当前版本 {current}）。\n是否打开下载页面？请下载新文件并删除旧文件。",
        "dialog.update.latest": "已是最新版本（{current}）。",
        "dialog.update.error": "无法检查更新：无法连接 GitHub 或响应无效。",
    },
    "ja": {
        "menu.file": "ファイル",
        "menu.file.quit": "終了",
        ...
        "menu.help.check_updates": "アップデートを確認…",
        "result.exact": "厳密値: {value}",
        "dialog.update.title": "アップデート",
        "dialog.update.available": "新しいバージョン {latest} があります（現在 {current}）。\nダウンロードページを開きますか？新しいファイルをダウンロードし、古いファイルを削除してください。",
        "dialog.update.latest": "最新バージョンです（{current}）。",
        "dialog.update.error": "アップデートを確認できませんでした: GitHub に接続できないか、応答が不正です。",
    },
}
